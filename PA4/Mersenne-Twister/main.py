...
class Mersenne():
    def __init__(self, c_seed=0):
        ...
        (self.w, self.n, self.m, self.r) = (32, 624, 397, 31)           # MT19937 32 bit
        self.a = 0x9908B0DF
        ...
        self.MT = [0 for i in range(self.n)]                            # make a arry to store the state of the generator
        self.index = self.n+1
        self.lower_mask = 0x7FFFFFFF
        self.upper_mask = 0x80000000
        
        self.c_seed = c_seed                                            # inital the seed
        self.seed(c_seed)
